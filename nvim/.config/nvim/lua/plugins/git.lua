return {
    {
        ...
        config = function()
            ...
            -- Hunk list via quickfix (super useful)
            map("n", "<leader>ghq", gs.setqflist, { desc = "Send hunks to quickfix list" })

            -- Toggle everything fast
    ...
    },
    {
        ...
        keys = {
            ...
            { "<leader>nc", function() require("neogit").open({ "commit" }) end, desc = "Neogit commit" },
            { "<leader>np", function() require("neogit").open({ "pull" }) end,   desc = "Neogit pull" },
            { "<leader>nP", function() require("neogit").open({ "push" }) end,   desc = "Neogit push" },
            { "<leader>nf", function() require("neogit").open({ "fetch" }) end,  desc = "Neogit fetch" },
        }
    }
}
